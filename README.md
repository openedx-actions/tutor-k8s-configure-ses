...
[![Tests](https://github.com/openedx-actions/tutor-k8s-configure-ses/actions/workflows/testRelease.yml/badge.svg)](https://github.com/openedx-actions/tutor-k8s-configure-ses/actions)
...
# tutor-configure-service-ses

Github Action to use Tutor to configure AWS SES smtp email service for use with Open edX
